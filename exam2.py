...
# SOURCE_DB_PASSWORD = "josesnat2020" # Your PostgreSQL password for dvdrental
...
# TARGET_DB_PASSWORD = "josesnat2020" # Your PostgreSQL password for my_database
